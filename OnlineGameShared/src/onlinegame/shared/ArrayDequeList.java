 ...
 * 
 * <p>Modified version of ArrayDeque that provide methods for fast random access.
 *
 * @author  Josh Bloch and Doug Lea
 * @since   1.6
 * @param <E> the type of elements held in this collection
 */
public class ArrayDequeList<E> extends AbstractCollection<E>
                           implements Deque<E>, List<E>, RandomAccess, Cloneable, Serializable
{
    ...
    public E get(int index)
    {
        ...
        return elements[(head + index) & len];
    }
